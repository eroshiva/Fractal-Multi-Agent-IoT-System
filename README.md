...
# ToDo - add more information about the tool and implemented packages...
...
```
cd existing_repo
git remote add origin https://gitlab.fel.cvut.cz/eroshiva/fractal-multi-agent-system.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.fel.cvut.cz/eroshiva/fractal-multi-agent-system/-/settings/integrations)
