...
generate-figures: build ## Generates figures based on the benchmarked data. It needs an exact name of the file carrying data!
	./build/_output/fractal-mais --greyScale --generateFigures benchmark_fmais_2023-03-26_01-59-08.json --generateFigures benchmark_meertcore_2023-04-04_21-14-18.csv
